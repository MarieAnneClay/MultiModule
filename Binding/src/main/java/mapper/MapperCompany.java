...
public class MapperCompany {
    ...
    public static Company toCompany(DTOCompany c) {
        ...
        ret.setId(Long.parseLong(c.getName()));
        ret.setName(c.getName());
        return ret;
    }

    /** Function converting a list of {@link Company} into a list of
     * {@link DTOCompany}.
    ...
    /** Function converting a list of {@link DTOCompany} into a list of
     * {@link Company}.
