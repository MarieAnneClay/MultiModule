...
public class MapperComputer {
  ...
  public static DTOComputer toDTOComputer(Computer computer, String lang) {
    ...
    try {
      returnComputer.setCompanyId(computer.getCompany().toString());
    } catch (NullPointerException e) {
  ...
  public static Computer toComputer(DTOComputer computer) {
    ...
    try {
      returnComputer.setCompany(Long.parseLong(computer.getCompanyId()));
      if (returnComputer.getCompany() == 0) {
        returnComputer.setCompany(null);
      }
    } catch (NumberFormatException e) {
      returnComputer.setCompany(null);
    }
