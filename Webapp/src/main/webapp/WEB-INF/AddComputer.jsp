	...
	<div class="container">
		<div class="row">
			<div class="col-xs-8 col-xs-offset-2 box">
				...
				<form:form modelAttribute="computerForm" id="addComputer" action="#"
					method="POST">
					<fieldset>
						<div class="form-group">
							...
							<form:input path="name" type="text" class="form-control"
								id="computerName" pattern="^[0-9a-zA-Zàâéèëêïîôùüç -_]{1,60}$"
								name="computerName" placeholder="${namePlaceholder}" required="true"
								value="${computer.getName()}"></form:input>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="companyId"><spring:message
									code="computer.companyName" /></label>
							<form:select path="companyId" class="input-lg form-control"
					...
					<div class="actions pull-right">
						<a class="btn btn-primary" id="addComputer" href="#"
							onclick="submitValidate();"><spring:message code="label.add" /></a>
						or <a
							href="
				   				<c:url value="/dashboard">
				   				</c:url>"
							class="btn btn-default"> <spring:message code="label.cancel" />
						</a>
					</div>
